  ...
  return (
		<div className='flex justify-between shadow-2xl rounded-full mx-10 my-5'>
			<div className='flex p-3'>
				...
				<Link href="/explore"><p className='m-auto px-3 font-bold hover:cursor-pointer'>Explore</p></Link>
				<Link href="/about"><p className='m-auto px-3 font-bold hover:cursor-pointer'>About</p></Link>
			</div>
